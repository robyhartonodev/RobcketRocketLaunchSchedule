    ...
    private void generateRocketList() {
        ...
        rocketCall.enqueue(new Callback<RocketList>() {
            ...
            public void onResponse(Call<RocketList> call, Response<RocketList> response) {
                ...
                rocketAdapter = new RocketAdapter(RocketActivity.this, response.body().getRockets());

                // Setup layout manager
                LinearLayoutManager layoutManager = new LinearLayoutManager(RocketActivity.this);
            ...
            public void onFailure(Call<RocketList> call, Throwable t) {
                ...
                recyclerView = findViewById(R.id.recycler_view_notice_list);
                rocketAdapter = new RocketAdapter(RocketActivity.this, rocketFailureList);
                ...
                // Show Toast
                Toast.makeText(RocketActivity.this,
